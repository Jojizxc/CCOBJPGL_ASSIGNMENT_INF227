...
public class CheckoutController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Image tablelamp = new Image(HomeController.dlamp.getProductImage());
        ...
        choicebox1.setnAction(this::computeTotal);
        ...
        if (HomeController.clamp.getProductStatus() || HomeController.blamp.getProductStatus() || HomeController.wlamp.getProductStatus()) {
            ...
            + Double.parseDouble(choicebox4.getValue()) * HomeController.wlamp.getProductPrice();
        }
